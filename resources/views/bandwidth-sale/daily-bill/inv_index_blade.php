...
@section('page_actions')
    ...
    <button class="btn btn-sm btn-primary ml-1" id="btnReceiveBill"
            data-toggle="modal" data-target="#invBillReceiveModal">
...
{{-- ═══════════════════════════════════════════════════════════
     BILL RECEIVE MODAL
═══════════════════════════════════════════════════════════ --}}
<div class="modal fade" id="invBillReceiveModal" tabindex="-1" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex justify-content-between">
                ...
                <button type="button" class="btn btn-primary px-4" id="invBtnSubmitReceive">
...
if (typeof $.fn.select2 !== 'undefined') {
    ...
    $('#invBillReceiveModal').on('shown.bs.modal', function () {
        if (!$('#rc_customer').hasClass('select2-hidden-accessible')) {
            $('#rc_customer').select2({ dropdownParent: $('#invBillReceiveModal'), width: '100%' });
...
// ── Submit Bill Receive ───────────────────────────────────────
$('#invBtnSubmitReceive').on('click', function () {
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res.success) {
                $('#invBillReceiveModal').modal('hide');
                Swal.fire({
