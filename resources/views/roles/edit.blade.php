...
@extends('layouts.app')
@section('page_title', 'Role Edit — ' . ucfirst($role->name))
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group mb-0">
                    ...
                    <small class="text-muted">Role name পরিবর্তন করা যাবে না।</small>
                </div>
            </div>
            <div class="card-footer">
                <button type="submit" class="btn btn-warning btn-block">
                    <i class="fas fa-save mr-1"></i> Permissions আপডেট করুন
                </button>
            </div>
        </div>
    </div>
