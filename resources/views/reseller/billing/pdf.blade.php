...
<?php
    $resellerId     = $invoice->customer->mac_reseller_id;
    $companyName    = \App\Models\ResellerSetting::get($resellerId, 'company_name', $invoice->customer->macReseller->business_name ?? config('app.name'));
...
<div class="info-section">
    <div class="info-left">
        ...
        <div class="info-text">
            ...
            Username: {{ $invoice->customer->pppoe_username ?? '-' }}<br>
            Package: {{ $packageName }}
        </div>
    </div>
...
<div class="items-wrap">
    <table class="items">
        ...
        <tbody>
            <tr>
                <td>Monthly Internet Bill — {{ $packageName }}</td>
...
<!-- Totals (no QR — reseller client-facing payment portal not built yet) -->
...
<div style="padding:12px 28px; font-size:11px; color:#777; border-top:1px solid #eee; margin-top:8px;">
    {{ $footerText }}
</div>
