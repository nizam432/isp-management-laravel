...
@section('title', 'Problem Category')

@section('content')

<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="m-0">Problem Category</h4>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h3 class="card-title mb-0"><i class="fas fa-tags mr-1"></i> Configure Support Categories</h3>
...
$('#btnAddSave').click(function () {
    ...
    $.ajax({
        url: '{{ route("reseller.client-support.category.store") }}',
        method: 'POST',
        data: {
            _token:        CSRF,
            name:          $('#add_name').val(),
...
$(document).on('click', '.btn-edit', function () {
    ...
    $.get(`/reseller/client-support/category/${id}/edit`, function (res) {
        if (res.success) {
...
$('#btnEditSave').click(function () {
    ...
    $.ajax({
        url: `/reseller/client-support/category/${id}`,
        method: 'POST',
        data: {
            _token:        CSRF,
            _method:       'PUT',
