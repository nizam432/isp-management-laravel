        ...
        <form method="GET" class="row align-items-end">
            <div class="col-md-4">
                ...
                <input type="text" name="search" class="form-control form-control-sm"
                       placeholder="Return No / Purchase No..." value="{{ request('search') }}">
            </div>
            <div class="col-md-2">
            ...
            <table class="table table-hover mb-0">
                <thead>
                    <tr style="background:#f8f9fa; border-bottom:2px solid #dee2e6;">
                        ...
                        <th style="padding:10px 12px;font-size:12px;color:#555;">Purchase No</th>
                        <th style="padding:10px 12px;font-size:12px;color:#555;">Date</th>
                        <th style="padding:10px 12px;font-size:12px;color:#555;">Vendor</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding:10px 12px;" class="text-center">
                            <a href="{{ route('inventory.purchase-returns.show', $return) }}"
                    ...
                    <tr>
                        <td colspan="7" class="text-center py-5 text-muted">
                            <i class="fas fa-undo fa-3x mb-3 d-block" style="opacity:.2;"></i>
                            No returns found.
                        </td>
                    </tr>
                    @endforelse
