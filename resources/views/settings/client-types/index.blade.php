...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0"><i class="fas fa-user-tag mr-2 text-success"></i>Client Type</h1>
        </div>
        <div class="col-sm-6">
...
<div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-md-5">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="filter-search" class="form-control" placeholder="Client type name...">
                    </div>
                </div>
                <div class="col-md-3">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title"><i class="fas fa-list mr-1"></i> Client Type List</h3>
            <div>
                <button class="btn btn-success btn-sm" id="btnAdd">
                    <i class="fas fa-plus mr-1"></i> Client Type
                </button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title text-white"><i class="fas fa-plus-circle mr-2"></i>Add Client Type</h5>
                <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label>Client Type Name <span class="text-danger">*</span></label>
                    <input type="text" id="add_name" class="form-control" placeholder="e.g. PPPOE, Home User...">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-white"><i class="fas fa-edit mr-2"></i>Edit Client Type</h5>
                <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
...
$(function () {
    ...
    var table = $('#ctTable').DataTable({
        processing: true,
        ajax: {
            url: '{{ route("settings.client-types.data") }}',
        ...
        pageLength: 10,
        language: {
            emptyTable:  'No client types found.',
            zeroRecords: 'No client types found.',
    ...
    $('#btnSave').on('click', function() {
        ...
        $.ajax({
            url:    '{{ route("settings.client-types.store") }}',
            method: 'POST',
            data: {
                _token:  '{{ csrf_token() }}',
                name:    $('#add_name').val(),
    ...
    $('#btnUpdate').on('click', function() {
        ...
        $.ajax({
            url:    '/settings/client-types/' + $('#edit_id').val(),
            method: 'PUT',
            data: {
                _token:    '{{ csrf_token() }}',
                name:      $('#edit_name').val(),
    ...
    $(document).on('click', '.btn-toggle', function() {
        var id = $(this).data('id');
        $.ajax({
            url:    '/settings/client-types/' + id + '/toggle',
            method: 'POST',
